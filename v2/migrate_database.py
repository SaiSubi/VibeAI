...
Migrates VibeAI v2 song database from SQLite to PostgreSQL (Neon)
"""
...
class DatabaseMigrator:
    ...
    def migrate_data(self):
        ...
        sqlite_cursor.execute("SELECT * FROM songs")
        ...
        print(f"✅ Successfully migrated {migrated_count} songs to PostgreSQL")
    ...
    def verify_migration(self):
        ...
        # Get sample data
        postgres_cursor.execute("SELECT id, title, artist, genre, language FROM songs LIMIT 5")
